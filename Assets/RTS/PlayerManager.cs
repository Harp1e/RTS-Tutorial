...
namespace RTS
{
    public static class PlayerManager
    {
        ...
        static void SavePlayer (JsonWriter writer, PlayerDetails player)
        {
            writer.WriteStartObject ();
        ...
        static void LoadPlayers(JsonTextReader reader)
        {
            while (reader.Read())
            {
        ...
        static void LoadPlayer(JsonTextReader reader)
        {
