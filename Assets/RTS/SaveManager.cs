...
namespace RTS
{
    public static class SaveManager
    {
        ...
        static void SaveGameDetails (JsonWriter writer)
        {
            SaveLighting (writer);
            SaveTerrain (writer);
            SaveCamera (writer);
        ...
        static void SaveLighting (JsonWriter writer)
        {
        ...
        static void SaveTerrain (JsonWriter writer)
        {
        ...
        static void SaveCamera (JsonWriter writer)
        {
            ...
            WriteVector (writer, "Position", cameraTransform.transform.position);
            WriteQuaternion (writer, "Rotation", cameraTransform.transform.rotation);
            WriteVector (writer, "Scale", cameraTransform.transform.localScale);

            writer.WriteEndObject ();
        }

        static void SaveResources (JsonWriter writer)
        {
        ...
        static void SavePlayers (JsonWriter writer)
        {
